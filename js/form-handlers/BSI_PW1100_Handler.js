class BSI_PW1100_Handler {
    ...
    configureEventListeners() {
        ...
        if (this.downloadPdfBtn) {
            this.downloadPdfBtn.addEventListener('click', () => this.pdfManager.download());
    ...
    async downloadPreviewAsPDF() {
        // Método migrado a PdfManager.js
        console.warn('downloadPreviewAsPDF() está obsoleto; use this.pdfManager.download()');
    }
    // ... existing code ...
}
